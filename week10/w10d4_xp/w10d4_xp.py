...
#
# Create a function called get_words_from_file. This function should read the file’s content and return
# the words as a collection. What is the correct data type to store the words?
#
